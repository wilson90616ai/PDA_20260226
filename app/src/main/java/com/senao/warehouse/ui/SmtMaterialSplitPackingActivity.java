...
public class SmtMaterialSplitPackingActivity extends Activity {

    private static final String TAG = SmtMaterialSplitPackingActivity.class.getSimpleName();
    private TextView mConnection;
    private EditText txtImportPartNo, txtImportDC, txtImportVC, txtImportOriginalQty, txtImportSplitQty, txtImportPo, txtImportQrCode, txtImportReelId, txtImportReelIdOriginalQty, txtImportReelIdSplitQty, txtImportReelIdPo, txtImportQrCodeSplitQty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smt_material_split_packing);
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(errorInfo)) {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(
                            SmtMaterialSplitPackingActivity.this);
        ...
        String subtitle = getString(R.string.label_smt_material_split_packing_eng);
//        String title = getString(R.string.label_smt_material_split_packing, subtitle);
    ...
    private boolean checkFields() {
        ...
        if (pnLayout.getVisibility() == View.VISIBLE) {
            ...
            if (TextUtils.isEmpty(txtImportOriginalQty.getText())) {
                ...
                Toast.makeText(getApplicationContext(), getString(R.string.enter_origin_qty), Toast.LENGTH_SHORT)
                        .show();
                return false;
            }
            ...
            if (Integer.parseInt(txtImportOriginalQty.getText().toString()) < 1) {
                txtImportOriginalQty.requestFocus();
                Toast.makeText(getApplicationContext(), getString(R.string.original_qty_must_more_than_0),
                        Toast.LENGTH_SHORT).show();
                return false;
            }
            ...
            if (TextUtils.isEmpty(txtImportSplitQty.getText())) {
                ...
                Toast.makeText(getApplicationContext(), getString(R.string.enter_split_qty), Toast.LENGTH_SHORT)
                        .show();
                return false;
            }
            ...
            if (Integer.parseInt(txtImportSplitQty.getText().toString()) < 1) {
                txtImportSplitQty.requestFocus();
                Toast.makeText(getApplicationContext(), getString(R.string.split_qty_more_than_0),
                        Toast.LENGTH_SHORT).show();
                return false;
            }
            ...
            if (Integer.parseInt(txtImportSplitQty.getText().toString())
                ...
                txtImportSplitQty.requestFocus();
                Toast.makeText(getApplicationContext(),getString( R.string.spilt_qty_cant_more_than_original_qty),
                        Toast.LENGTH_SHORT).show();
                return false;
            }
...
//            }
            ...
            if (Integer.parseInt(txtImportReelIdSplitQty.getText().toString())
                    > Integer.parseInt(txtImportReelIdOriginalQty.getText().toString())) {
                txtImportReelIdSplitQty.requestFocus();
                Toast.makeText(getApplicationContext(), getString( R.string.spilt_qty_cant_more_than_original_qty),
                        Toast.LENGTH_SHORT).show();
                return false;
...
//            }
            ...
            if (Integer.parseInt(txtImportQrCodeSplitQty.getText().toString())
                    > Integer.valueOf(qty)) {
                txtImportQrCodeSplitQty.requestFocus();
                Toast.makeText(getApplicationContext(), getString( R.string.spilt_qty_cant_more_than_original_qty),
                        Toast.LENGTH_SHORT).show();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (savePrinterInfo(etIP.getText().toString().trim(), etPort.getText().toString().trim(), etQty.getText().toString().trim())) {
                            alertDialog.dismiss();
                            dialog = ProgressDialog.show(SmtMaterialSplitPackingActivity.this,
                            ...
                            for (int j = 0; j < printTimes; j++) {
                                int originalQty = Integer.valueOf(getQty());
                                int splitQty = Integer.valueOf(getSplitQty());
                                ...
                                if (!printLabel(reelId, getPartNo(), pnInfo.getPartDescription(), String.valueOf(newQty)
                                    ...
                                    printClose();
                                    Toast.makeText(getApplicationContext(), R.string.reprinting_due_to_issue_with_new_label, Toast.LENGTH_LONG).show();
                                    dialog.dismiss();
                                    return;
                                }
                                ...
                                if (!printLabel(subMlInfo.getReelIds()[0], getPartNo(), pnInfo.getPartDescription(), String.valueOf(splitQty)
                                        , getDateCode(), getVendorCode(), po, qrCode)) {
                                    printClose();
                                    Toast.makeText(getApplicationContext(), R.string.reprinting_due_to_issue_with_sub_package_label, Toast.LENGTH_LONG).show();
                                    dialog.dismiss();
                                    return;
                                }
                            }
...
//            y = mm2dot(20);
    ...
    private boolean savePrinterInfo(String ip, String port, String qty) {
        ...
        try {
            Preferences.setString(this, Preferences.SMT_PRINTER_IP, ip);

            Preferences.setString(this, Preferences.SMT_PRINTER_PORT, port);

            Preferences.setString(this, Preferences.SMT_PRINTER_QTY, qty);
    ...
    private class GetReelIdSubList extends
            AsyncTask<Integer, String, MaterialLabelHelper> {
