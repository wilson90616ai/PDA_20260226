...
public class SamsaraPoActivity extends Activity {

    private static final String TAG = SamsaraPoActivity.class.getSimpleName();
        ...
        mConnection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(errorInfo)) {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(SamsaraPoActivity.this);
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if ((event.getAction() == KeyEvent.ACTION_UP) && (keyCode == KeyEvent.KEYCODE_ENTER)) {
                    ...
                    if (TextUtils.isEmpty(dn)) {
                        Toast.makeText(SamsaraPoActivity.this, getString(R.string.dn_num_is_not_null), Toast.LENGTH_SHORT).show();
                        return true;
                    } else {
...
//                }
    ...
    private void setTitle() {
        ...
        text = new SpannableString(getString(R.string.title_activity_samsara_po1, AppController.getOrgName()));
    ...
    private Dialog onCreateChoosePrinterDialog(final SamsaraPoInfoHelper helper) {
        ...
        builder.setTitle(getString(R.string.label_printer_info) + getString(R.string.label_total2) + tol + getString(R.string.label_pages))
                .setView(item)
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (saveSophosPrinterInfo(etIP.getText().toString().trim(), etPort.getText().toString().trim(), etQty.getText().toString().trim())) {
                            alertDialog.dismiss();
                            dialog = ProgressDialog.show(SamsaraPoActivity.this,
