...
public class CustomerMaterialLabelReprintActivity extends Activity {
    private static final int REQUEST_ENABLE_BT = 1;
    private static final int REQUEST_PRINTER_SETTING = 2;
    private static final int REQUEST_BLUETOOTH_SETTINGS = 3;
    private static final String TAG = CustomerMaterialLabelReprintActivity.class.getSimpleName();
    ...
    private EditText txtImportQty, txtImportPartNoCustomer, txtImportPartNo, txtImportDC, txtImportVC,
            txtImportPo, txtImportQrCode, txtImportReelId, txtImportReelIdQty, txtImportReelIdPo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_material_label_reprint);
        ...
        mConnection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(errorInfo)) {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(CustomerMaterialLabelReprintActivity.this);
        ...
        String subtitle = getString(R.string.label_customer_material_label_reprint_eng);
        String title = getString(R.string.label_customer_material_label_reprint1,AppController.getOrgName(), subtitle);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (savePrinterInfo(etIP.getText().toString().trim(), etPort.getText().toString().trim(), etQty.getText().toString().trim())) {
                            alertDialog.dismiss();
                            dialog = ProgressDialog.show(CustomerMaterialLabelReprintActivity.this, getString(R.string.holdon), getString(R.string.printingLabel), true);
                            ...
                            for (int j = 0; j < printTimes; j++) {
                                ...
                                if (!printLabel(reelId, getPartNo(), pnInfo.getPartDescription(), qty, getDateCode(), getVendorCode(), po, qrCode, getCustomerPartNo())) {
                                    printClose();
    ...
    private void printLabel() {
        ...
        if (!BtPrintLabel.printCustomerMaterialLabel1(reelId, getPartNo(), pnInfo.getPartDescription(), String.valueOf(qty), getDateCode(), getVendorCode(), po, qrCode, getCustomerPartNo(),orgPrint)) {
