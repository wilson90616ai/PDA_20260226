...
public class CustomerMaterialReceiptsLabelActivity extends Activity {
    private static final int REQUEST_ENABLE_BT = 1;
    private static final int REQUEST_PRINTER_SETTING = 2;
    private static final int REQUEST_BLUETOOTH_SETTINGS = 3;
    private static final String TAG = CustomerMaterialReceiptsLabelActivity.class.getSimpleName();
    private TextView mConnection, labelListSummary, labelListSummaryReelId, lblTitle;
    private EditText txtImportQty, txtImportPartNoCustomer, txtImportPartNo, txtImportDC, txtImportVC,
            txtImportPackQty, txtImportPoWithQty, txtImportQrCode, txtImportReelId, txtImportReelIdQty,
            txtImportReelIdPackQty, txtImportReelIdPoWithQty, txtImportQrCodePackQty;
    ...
    private List<String> poWithQtyListReelId = new ArrayList<>();
    private List<String> poWithQtyListPn = new ArrayList<>();
    private int selectedIndex;
    private String mCustomerPartNo,orgPrint="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_material_print);
        ...
        mConnection.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(errorInfo)) {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(CustomerMaterialReceiptsLabelActivity.this);
        ...
        String subtitle = getString(R.string.label_customer_material_receipts_label_eng);
        String title = getString(R.string.label_customer_material_receipts_label1, AppController.getOrgName(), subtitle);
        ...
        lvReelId.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(CustomerMaterialReceiptsLabelActivity.this);
    ...
    private boolean checkFields() {
        ...
        if (pnLayout.getVisibility() == View.VISIBLE) {
            ...
            if (poWithQtyListPn.isEmpty()) {
                /*txtImportPoWithQty.requestFocus();
                Toast.makeText(getApplicationContext(), "請輸入PO及數量", Toast.LENGTH_SHORT).show();
                return false;*/
            } else {
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (savePrinterInfo(etIP.getText().toString().trim(), etPort.getText().toString().trim(), etQty.getText().toString().trim())) {
                            alertDialog.dismiss();
                            dialog = ProgressDialog.show(CustomerMaterialReceiptsLabelActivity.this, getString(R.string.holdon), getString(R.string.printingLabel), true);
                            ...
                            for (int j = 0; j < printTimes; j++) {
                                //printTest();
                                int importQty = Integer.valueOf(getQty());
                                int packQty = Integer.valueOf(getPackQty());
                                ...
                                for (int i = 0; i < times; i++) {
                                    ...
                                    if (!printLabel(reelId, getPartNo(), pnInfo.getPartDescription(), String.valueOf(qty)
                                            , getDateCode(), getVendorCode(), getPo(), qrCode, getCustomerPartNo())) {
                                        printClose();
    ...
    private void printLabel() {
        ...
        for (int i = 0; i < times; i++) {
            ...
            AppController.debug("orgPrint => "+orgPrint);

            if (!BtPrintLabel.printCustomerMaterialReceiptsLabel(reelId, getPartNo(), pnInfo.getPartDescription(), String.valueOf(qty), getDateCode(), getVendorCode(), getPo(), qrCode, pnInfo.getCustomerPartNo(),orgPrint)) {
                Toast.makeText(getApplicationContext(), getString(R.string.print_error), Toast.LENGTH_LONG).show();
                dialog.dismiss();
                return;
            }
    ...
    private void onCreateChoosePnSelectDialog() {
        ...
        dialog_list.setNegativeButton(R.string.btn_cancel, new DialogInterface.OnClickListener() {
    ...
    private class GetPNInfoFromSfis extends AsyncTask<Integer, String, PnItemInfoListHelper> {
        ...
        protected PnItemInfoListHelper doInBackground(Integer... params) {
            AppController.debug("Get PNInfo Sfis from " + AppController.getServerInfo() + AppController.getProperties("GetPNInfoSfis"));
